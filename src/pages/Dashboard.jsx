...
import {
  FiUser, FiBriefcase, FiBell, FiMessageCircle, FiUserCheck, FiHeart, FiFileText, FiUsers, FiBarChart2, FiMenu, FiX, FiPlusSquare
} from 'react-icons/fi';
...
const Dashboard = ({ user, onLogout }) => {
  ...
  //       icon: <FiBarChart2 />, // For analytics and overview
  //       content: "Company dashboard" // Replace with your actual component
  //     },
  //     {
  //       key: 'manage',
  //       label: 'Manage Employees',
  //       icon: <FiUsers />,
  //       content: "Employees List Component" // Replace with actual component
  //     },
  //     {
  //       key: 'jobs',
  //       label: 'Manage Jobs',
  //       icon: <FiBriefcase />,
  //       content: <JobList user={user} />
  //     },
  //     {
  //       key: 'applicants',
  ...
  //       icon: <FiHeart />,
  //       content: 'Shortlisted Resumes Component' // Replace with actual component
  //     }
  //   ]
  //   ,
  //   employee: [
  ...
  //       label: 'Dashboard',
  //       icon: <FiBarChart2 />,
  //       content: 'Dashboard Overview with job stats, recent activity, and candidate insights.'
  //     },
  ...
  //       label: 'Manage Jobs',
  //       icon: <FiBriefcase />,
  //       content: 'View, edit, or delete jobs you have posted. Track job performance and status.'
  //     },
  //     {
  //       key: 'applicants',
  //       label: 'All Applicants',
  //       icon: <FiUsers />,
  //       content: 'Browse and review all candidate applications submitted to your jobs.'
  //     },
  //     {
  //       key: 'shortlisted',
  //       label: 'Shortlisted Resumes',
  //       icon: <FiHeart />,
  //       content: 'Access and manage the list of candidates you have shortlisted.'
  //     },
  //     {
  //       key: 'resume-alerts',
  //       label: 'Resume Alerts',
  //       icon: <FiBell />,
  //       content: 'Receive alerts when new resumes match your job postings.'
  //     }
  //   ]
  ...
  const roleSpecificMenu = {
  candidate: [
    { key: 'profile', label: 'My Profile', icon: <FiUser />, path: '/candidate/profile' },
    ...
    { key: 'view', label: 'View Profile', icon: <FiUser />, path: '/candidate/view-profile' }
  ],
  superadmin: [
