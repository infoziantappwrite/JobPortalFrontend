...
const ApplicantListEdit = () => {
  ...
  const handleStatusUpdate = async () => {
    ...
    try {
      // Try to get application ID reliably
      const applicantID =
        selectedApplication.applicationID?._id ||
  ...
  if (loading) return <InternalLoader text="Loading Shortlisted" />;
    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-xl font-semibold text-gray-800">
          Shortlisted for <span className="text-indigo-600">{job?.title}</span>
        </h3>
...
export default ApplicantListEdit;
