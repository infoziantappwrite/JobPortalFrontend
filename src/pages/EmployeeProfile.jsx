...
import {
  FiUser, FiMail, FiBriefcase, FiShield, FiCalendar, FiCheckCircle
} from 'react-icons/fi';
...
const EmployeeProfile = () => {
  ...
  if (!userInfo) return <p className="text-center">No user data found.</p>;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-200/30 via-white to-indigo-200/30 flex items-center justify-center p-6">
      <div className="w-full max-w-3xl bg-white/90 backdrop-blur-md p-10 rounded-3xl shadow-xl space-y-10 border border-indigo-100">
        <div className="text-center">
          ...
          <p className="text-sm text-indigo-700 font-medium capitalize mt-1">
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-semibold text-indigo-700 border-b pb-1 border-indigo-300">User Details</h3>
