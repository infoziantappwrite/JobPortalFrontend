...
const DashboardLayout = () => {
  ...
  const roleSpecificMenu = {
    ...
    company: [
      { key: 'dashboard', label: 'Company Dashboard', icon: <FiHome />, path: '/company/dashboard' },
      { key: 'viewJobs', label: 'View Jobs', icon: <FiClipboard />, path: '/company/view-jobs' },
      { key: 'applicants', label: 'View Applicants', icon: <FiList />, path: '/company/applicants' },
